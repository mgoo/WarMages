...
public class DataLoader {
  ...
  public DataLoader(String animationsFile, String spriteSheetTypesFile, String spriteSheetsFile, String imagesFile,
                    String attacksFile, String unittypesFile, String abilitiesFile) {
  ...
  private void loadSpriteSheetTypes(String file) {
    try {
      ...
      SpriteSheetTypeData[] spriteSheetTypesData = new Gson().fromJson(spriteSheetTypesFile, SpriteSheetTypeData[].class);
  ...
  private void loadSpriteSheets(String file) {
    try {
      ...
      SpriteSheetData[] spriteSheetsData = new Gson().fromJson(spriteSheetsFile, SpriteSheetData[].class);
